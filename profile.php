...
<head>
  ...
  <title>WINI_LECTURE - Teacher's profile</title>
  <link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
  <h2>WINI_LECTURE - Teacher's profile</h2>
...
<?php
  ...
  require_once('connectvars.php');
   ...
   // $currency = $_GET['currency'];
    ...
    $query = "SELECT name, description FROM cost WHERE name = $teacher";
    mysqli_query($dbc, $query);
    mysqli_close($dbc);


    echo '<p>Are you sure you want to delete the following high score?</p>';
    echo '<p><strong>teacher: </strong>' . $name . '<br /><strong>description: </strong>' . $description .
      '</p>';
